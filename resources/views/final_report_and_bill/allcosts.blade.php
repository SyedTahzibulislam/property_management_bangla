...
<div id="intitalhisab" class="container" style="background-color:#006699">
  ...
  <b style="color:white" >Initial  Discount<br></b>  <input type="text" id="initialfinaldiscount" name="initialfinaldiscount"  value="{{$fdiscount}}" readonly>
	...
	<div class="col-4">
 <b style="color:white" >Initial  DUE <br></b> <input type="text" id="initialfinaldue" name="initialfinaldue"  value="{{$data->due}}" readonly>
    </div>
</div>
<p>
<div class="row">
...
<div id="additionalservice" >
  ...
  <b style="color:white" > চূড়ান্ত হিসাব </b>
   ...
   <div class="row"   style="background-color:#2F4F4F"       >
		 ...
		 <b style="color:white" >Gross Amount:</b> <input type="text" name="finalTotalcost" id="finalTotalcost" value="{{$fadjust}}"   class="form-control numbers totalamount"  />
    </div>

			<div class="col-4">
 
		 <b style="color:white" >Recieveable Amount:</b> <input type="text" name="finalreceiveableamount" id="finalreceiveableamount" value="{{$fadjust - $fdiscount}}"   class="form-control numbers finalreceiveableamount"  />
    </div>	

	    <div class="col-4">
       <b style="color:white" >Total paid:</b><input type="text" name="fianl_paid_after_adjusting_service_charge" id="fianl_paid_after_adjusting_service_charge" value="{{$fadjust - $data->due - $fdiscount }}" class="form-control numbers due" />
    </div>
  ...
  <div class="row">
  	    ...
  	    <div class="col-6">
       <b style="color:white" >Total Discount:</b><input type="text" name="finaldis" id="finaldis" value="{{$fdiscount}}" class="form-control numbers finaldis"    />
    </div>
  		    <div class="col-6">
 
		 <b style="color:white" >Total Commission:</b> <input type="text" name="finalcommission" id="finalcommission" value="{{$fcommission}}"   class="form-control numbers finalcommission"   />
    </div>	
  </div>
  ...
  <div class="row"                 >
    ...
    <div class="col-6">
       <b style="color:white" >Total Due:</b><input type="text" name="final_due_after_adjusting_service" id="final_due_after_adjusting_service" value="{{$data->due}}" class="form-control numbers final_due_after_adjusting_service" readonly  />
    </div>
	
	    <div class="col-6">
       <b style="color:white" >Total Due Payment:</b><input type="text" name="duepayment" id="duepayment"  class="form-control numbers duepayment" value="0" required />
    </div>
	<p>
 </div>
 <p>
...
$("#additionalservice").show();
 ...
 console.log('AAA'); 
    $('#a')[0].reset();
	  ...
	  var fianl_paid_after_adjusting_service_charge = '<?php echo $fadjust - $data->due - $fdiscount; ?>'
...
var due  =  parseFloat($("#final_due_after_adjusting_service").val());

var newdue = due -duepayment ;
