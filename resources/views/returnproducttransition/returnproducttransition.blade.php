...
<body id="bodysellcorner">
  ...
  <span id="form_result"></span>
		...
		<form method="post" action="{{ route('returnproduct.store') }}"   id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          @csrf
...
<input type="hidden" name="paid" id="paid"  value="0"  autocomplete="off"   class="form-control numbers paid"  />
		  

    <div class="col-4">
      
		Due Adjustment:   <input type="text" name="due" id="due_at_the_time_of_selling" value="0" class="form-control numbers due" readonly />
...
$(document).ready(function(){
    ...
    var table = $('#patient_table').DataTable({
        ...
        ajax: "{{ route('returnproduct.index') }}",
        columns: [
...
function fetch()
{
 ...
 $.ajax({
   url:"returnproduct/dropdownlist",
   dataType:"json",
