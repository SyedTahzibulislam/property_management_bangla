...
<h6 style="color:red;">আপনি যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের -  যে কোন একটি নির্দিষ্ট খরচ দেখতে চান তা নিচের  ফিল্ডে লিখুন। 
...
<form   class="khorochform"   method="post"       action="{{route('khorochtransition.fetchkhoroch')}}"   >
 @csrf
...
Expenses Name:
<select required class="khorocer_khad" style="width:300px;" name="khorocer_khad" id="khorocer_khad" >
  <option value=""></option>
    <option value="1.1">ALL</option>
@foreach ( $khorocer_khad as $k  )
...
Project:
<select  required style="width:300px;" class="project"  id="project"   name="project"  >
  <option value=""></option>
  <option value="1.1">ALL</option>
