...
<div class="container">
  <div class="row">
    ...
    <h6 style="color:red;"> মেডিসিন কোম্পানির  সাথে দেনা বা পাওনার হিসাব মিটিয়ে ফেলেন।   </h6>
        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" action="{{ route('medcinercompanydenapawanshod.transition') }}" class="form-horizontal pawnaordenashod " enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
             <input type="text" name="due" id="companydue" class="form-control numbers" readonly />
            </div>
           </div>
            ...
            <div class="col-md-8">
             <input type="text" name="advance" id="companyadvance" class="form-control numbers" readonly />
            </div>
           </div>
