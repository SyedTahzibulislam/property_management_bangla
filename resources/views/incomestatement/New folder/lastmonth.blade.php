...
<div class="container">
  ...
  <h2 style="color:red">    গত মাসের খরচ </h2>
  <hr>
  
  <h5 style="color:red;"> বিভিন্ন খাতে গত মাসের  খরচের পরিমাণ </h5>
  <table class="table"> 
  <thead>
    <tr>
...
<hr>
<span style="color:blue;"> বিভিন্ন খাতে গত মাসের   মোট খরচঃ  </span> <?php echo $totalkhoroch  ?> টাকা 
...
<span style="color:blue;"> বাকি/ঋণ শোধ বাবদ মোট খরচঃ  </span> <?php echo $totaldharshod  ?> টাকা 
  ...
  <br><br>
   <hr >
  <b style="color:green" > গত মাসের খরচের  সামারি  </b>
  <br>
...
(-)
 ...
 <br>(+) 
 <hr  style="width:50%">
<span style="color:red;"> সুতরাং  গত মাসের মোট খরচ    </span> <?php echo $totalkhorochafteradjustingdue = ($nogodkroy+ $totaldharshod) ?> টাকা  
...
<h2 style="color:green">      গত মাসের বিক্রি </h2>
<hr>
