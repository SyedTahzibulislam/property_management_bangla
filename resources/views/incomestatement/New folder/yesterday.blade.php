...
<div class="container">
  ...
  <h2 style="color:red">    গতকালকের  খরচ </h2>
  <hr>
  
  <h5 style="color:red;"> বিভিন্ন খাতে গতকালকের খরচের পরিমাণ </h5>
  <table class="table">
  <thead>
    <tr>
...
<hr>
<span style="color:blue;"> বিভিন্ন খাতে গতকালকের   মোট খরচঃ  </span> <?php echo $totalkhoroch  ?> টাকা 
...
<h5 style="color:red">    গতকালকের দিনে পূর্বের বাকি/ঋণ শোধ বাবদ খরচ  </h5>
  <hr>
  <table class="table">
  <thead>
    <tr> 
...
<span style="color:blue;"> বাকি/ঋণ শোধ বাবদ মোট খরচঃ  </span> <?php echo $totaldharshod  ?> টাকা 
  ...
  <br><br>
   <hr >
  <b style="color:green" > গতকালকের খরচের  সামারি  </b>
  <br>
...
(-)
 ...
 <br>(+) 
 <hr  style="width:50%">
<span style="color:red;"> সুতরাং গতকালকের মোট খরচ    </span> <?php echo $totalkhorochafteradjustingdue = ($nogodkroy+ $totaldharshod) ?> টাকা  
  
<hr style="width:50%">

<b  style="background-color:#00FEFE">বি দ্রঃ গতকালকের আপনি যে পরিমাণ বাকিতে ক্রয় করেছেন তার পরিমাণঃ {{ $totalbaki}} টাকা। এই টাকাকে খরচের থেকে বাদ দেয়া হয়েছে। এই টাকা যে তারিখে শোধ দিবেন , সেই তারিখের খরচের সাথে যুক্ত হবে।   </b>
...
<h2 style="color:green">      গতকালকের বিক্রি </h2>
<hr>
...
<b style="background-color:#FF00FF" >  #আজকে গ্রাহকদের থেকে আদায় করা ভ্যাটের পরিমাণ </b> <br><br> 
 ...
 <b  style="background-color:#00FEFE">বি দ্রঃ গতকালকের আপনি যে পরিমাণ পণ্য/সেবা  বাকিতে বিক্রয়  করেছেন তার পরিমাণঃ {{ $total_due_patho}} টাকা। এই টাকাকে আয়  থেকে বাদ দেয়া হয়েছে। আয় শুধু নগদ আয়ের উপর হিসাব করা হচ্ছে। এই বাকি টাকা যে তারিখে গ্রাহক শোধ দিবে সেই তারিখের আয় হিসাবে যুক্ত হবে।   </b><br>
