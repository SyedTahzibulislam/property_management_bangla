...
if yes then exexute  -->
 ...
 <br><br>
<?php if (!$cabinetransaction->isEmpty())  { ?>
<h5 style="color:red">   ক্লিনিকের  কেবিন /বেড  খাতে  আজকে বিক্রিত মোট সেবার  পরিমাণ  </h5>
  <hr>
  <table class="table table-responsive">
  <thead>
    <tr> 
 ...
 <th scope="col"> ছাড়ে বিক্রির সেবার  পরিমাণ ( নেট প্রাইস - ডিস্কাউন্ট )   </th>
  ...
  <tbody>
	...
	@foreach($cabinetransaction as $cabine  )
	
	<?php 
	
$totalsell_from_cabine_by_substracting_discount= $totalsell_from_cabine_by_substracting_discount+ $cabine->amount ;
$total_discount_in_cabine= $total_discount_in_cabine + $cabine->discount ;



$net_sell_in_cabine_in_every_single_iiteration = (	$cabine->amount + $cabine->discount );
$net_sell_from_cabine_from_all_itteration_of_loop = $net_sell_in_cabine_in_every_single_iiteration + $net_sell_from_cabine_from_all_itteration_of_loop ;
	
	
	?>
	<tr>
	  <th >{{$cabine->day}}</th>
	  <th >{{$cabine->cabinelist->serial_no}}</th>

	  <td>{{ $net_sell_in_cabine_in_every_single_iiteration }}</td>
      
	
      <td>{{$cabine->discount}}</td>
	  <td>{{$cabine->amount}}</td>
    </tr> 
@endforeach
...
<hr>
<span style="color:blue;">   বিক্রি করা সেবা (নেট এমাউন্ট): </span> <?php echo $net_sell_from_cabine_from_all_itteration_of_loop  ?> টাকা <br>

<span style="color:blue;"> মোট  ডিস্কাউন্ট এর  পরিমাণঃ     </span> <?php echo $total_discount_in_cabine  ?> টাকা <br> <br><hr style="height:2px; width:100%; border-width:0; color:red; background-color:red" > 
<b><span style="color:green;">  ( নেট এমাউন্ট    - ডিস্কাউন্ট) :  </span> </b> {{$net_sell_from_cabine_from_all_itteration_of_loop}} - {{$total_discount_in_cabine}} =     <?php echo $totalsell_from_cabine_by_substracting_discount  ?> টাকা <br>
    <span style="color:blue;">  বাকিতে বিক্রির পরিমাণঃ   </span>  {{$total_due_cabine}} টাকা <br>
  (-) 
  <hr>
   <b> <span style="color:blue;">  সুতরাং ডিস্কাউন্ট এর পরে,  মোট নগদ সার্জারি খাতে সেবা বিক্রির পরিমাণঃ    </span> <?php $mot_nogod_sell_from_cabine =  $totalsell_from_cabine_by_substracting_discount - $total_due_cabine ?>  {{ $mot_nogod_sell_from_cabine }}      টাকা <br></b>
  <br> 
...
<span style="color:red;"> কেবিন/সিট ভাড়া বাবদ নগদে সেবা বিক্রি  বিক্রিঃ      </span> <?php echo $mot_nogod_sell_from_cabine ?> টাকা <br>
...
(+) <hr style="width:50%">
  <span style="color:red;"> মোট নগদ আয়   </span> <?php $final_income= $mot_nogod_sell_from_surgery + $mot_nogod_sell_from_medicine +$mot_nogod_sell_from_cabine +$mot_nogod_income_from_pathology+ $total_due_paid ?> {{ $final_income }}    টাকা <br>
...
<b style="background-color:#FF00FF" >  #বাকিতে  বিক্রির পরিমাণ </b> <br><br> 
 ...
 <b  style="background-color:#00FEFE">বি দ্রঃ আজকের আপনি যে পরিমাণ পণ্য/সেবা  বাকিতে বিক্রয়  করেছেন তার পরিমাণঃ {{ $total_due_patho}} টাকা। এই টাকাকে আয়  থেকে বাদ দেয়া হয়েছে। আয় শুধু নগদ আয়ের উপর হিসাব করা হচ্ছে। এই বাকি টাকা যে তারিখে গ্রাহক শোধ দিবে সেই তারিখের আয় হিসাবে যুক্ত হবে।   </b><br>
