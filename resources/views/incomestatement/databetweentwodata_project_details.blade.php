...
<h5 style="color:red">  Money given by Owner to Supervisors  </h5>
  ...
  <tbody>
	...
	<?php  
	$money_given_by_owner_to_supervisor = $money_given_by_owner_to_supervisor + $e->amount;
...
@endforeach
 ...
 <?php 
$total_expenses = $total_expenses_paid+$total_salary_amount+$money_return_back_from_project+$total_due_paymet+$total_caopnay_paid+$total_company_duepayment+ $customer_refundt+ $total_withdrawl_owner+ $agentcommission;

$total_earn =$total_paid_income+$money_given_by_owner_to_supervisor
+$total_due_collection+$total_company_refund+ $total_plot_sell + $customer_due_paymentt+ $total_investment;
