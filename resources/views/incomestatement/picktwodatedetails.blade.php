...
<br>
<h6  style="background-color:yellow" >যদি শুধু একটি নির্দিষ্ট ডেটের আয় ও খরচের হিসাব দেখতে চান সেই ক্ষেত্রে <b style="color:green"> শেষের তারিখ</b> এর স্থলে ফাঁকা রাখেন।  </h6>

<form      method="post"  action="{{route('incomestatbtwtwodatedetails')}}"   >
 @csrf
...
প্রজেক্টঃ 
<select  style="width:300px;" name="project" id="project" required>
  <option value=""></option>
