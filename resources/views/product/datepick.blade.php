...
<h6 style="color:red;">আপনি যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের মোট  সেল রিপোর্ট  দেখতে চান তা নিচের ইনপুট ফিল্ডে লিখুন। 
ধরুন আপনি ১ আগষ্ট ২০২১  হতে ৭ আগষ্ট ২০২১ পর্যন্ত হওয়া  ব্যালেন্স সেল রিপোর্ট  দেখতে চাচ্ছেন। 
...
<br>
<h6  style="background-color:yellow" >যদি শুধু একটি নির্দিষ্ট ডেটের সেল রিপোর্ট  দেখতে চান সেই ক্ষেত্রে <b style="color:green"> শেষের তারিখ</b> এর স্থলে প্রথম তারিখটা বসান । অর্থাৎ দুই ফিল্ডে একই তারিখ বসান। ধরেন শুধু ৭ আগষ্ট এর ট্রাঞ্জিশন দেখতে চান। সেই ক্ষেত্রে দুই জায়গায় ই ৭ আগষ্ট লিখুন।   </h6>

<form      method="post"  action="{{route('producttransition.salereportfetch')}}"   >
 @csrf
