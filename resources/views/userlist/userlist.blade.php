...

{
	...
	<td><button   id="{{$user->id}}"    class=" edit btn btn-primary" >Edit Role </button>
	<a href="{{ url('showuserlist/destroy/' )  }}/{{ $user->id}} "  > <button   class="btn btn-danger" >   Delete  </button></td> </a> 
  </tr>
@endforeach
        </tbody>
    </table>
