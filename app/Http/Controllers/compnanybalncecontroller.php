...
class compnanybalncecontroller extends Controller
{
 ...
 $validator = Validator::make($request->all(), [
		...
		$datethatsentasenddatefromcust =  date("Y-m-d",strtotime($request->input('enddate')));
					...
					$data = Productcompany::findOrFail($request->company);
		...
		$ordertillfirstdate =	productcompanyorder::with('productcompanytransition','Productcompany','user')->where('productcompany_id', $request->company )
...
$obtillfirstdate = $obtillfirstdate+ $o->debit;
				...
				$order =productcompanyorder::with('productcompanytransition','Productcompany','user')->where('productcompany_id', $request->company )
