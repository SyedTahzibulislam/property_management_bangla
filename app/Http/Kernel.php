...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
		...
		'isAccount' => \App\Http\Middleware\Accountsection::class,
		'isDoctor' => \App\Http\Middleware\isDoctor::class,
		'isProjectsupervisors' => \App\Http\Middleware\projectsupervisors::class,
		'isPhermachy' => \App\Http\Middleware\phermachysection::class, 
		'isdeleteduser' => \App\Http\Middleware\deleteduser::class,
		'customer' =>  \App\Http\Middleware\customermissdleware::class,
