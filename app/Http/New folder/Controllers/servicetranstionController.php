...
$patientdue = patient::findOrFail($request->patient_id)->due ;

if ( $request->final_due_after_adjusting_service >  $patientdue   )
{
	...
	$duetransition->comment = "Due in bed and cabine fair";	
